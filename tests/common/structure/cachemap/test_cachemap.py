...
from scouterx.common.structure.cachemap.cachemap import CacheMap
...
class TestCacheMap(unittest.TestCase):
    ...
    def test_cache_set_and_size(self):
        ...
        self.assertEqual(self.cacheMap.size(), 10, "Size should not change.")

        self.assertTrue(self.cacheMap.contains(0), "0 should be contained.")

        self.cacheMap.add(1000, "1000")
        self.assertEqual(self.cacheMap.size(), 10, "Size error after adding new element.")
        self.assertFalse(self.cacheMap.contains(0), "0 should have been removed.")

        self.assertTrue(self.cacheMap.contains(1), "1 should still be contained.")

        self.cacheMap.add(1001, "1001")
        self.assertEqual(self.cacheMap.size(), 10, "Size error after another addition.")
        self.assertFalse(self.cacheMap.contains(1), "1 should have been removed.")
        self.assertTrue(self.cacheMap.contains(1001), "1001 should be present.")
